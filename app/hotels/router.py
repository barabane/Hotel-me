...
@cache(expire=30)
async def get_hotel(
    location: str, dates: SchemaHotelsDateFromTo = Depends(SchemaHotelsDateFromTo)
):
    ...
    return await HotelDAO.find_not_empty_hotels(
        location, dates.date_from, dates.date_to
    )
